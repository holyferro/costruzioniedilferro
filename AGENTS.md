# Codex — Impresa Edile SRL Website
...
- sviluppo locale con VS Code + Codex
...
## Lock-ins from AGENTS.md — Validation
...
| Tool                                                           | Purpose                            | Notes                                                                                      |
| -------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------ |
| **VS Code + official Tailwind / ESLint / Prettier extensions** | Editor integration                 | User already uses VS Code per AGENTS.md.                                                   |
| **Vercel Preview Deploys**                                     | Per-PR staging                     | Already in workflow per AGENTS.md. Lets the client review every phase without local setup. |
