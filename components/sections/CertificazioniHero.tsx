...
export function CertificazioniHero({
  ...
  return (
    <section className="bg-panna text-ink flex h-[calc(100svh-var(--header-height))] flex-col py-8 md:py-12">
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 md:px-12">
        <div className="mx-auto max-w-3xl flex-none text-center">
          ...
          <p className="text-ink/70 mx-auto mt-5 max-w-[52ch] text-base leading-relaxed md:text-lg">
            {subtitle}
          </p>
        </div>
