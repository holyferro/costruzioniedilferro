...
**Success Criteria** (what must be TRUE):
  1. Sopra la piega (mobile 375px) è visibile: foto reale di cantiere, titolo autorevole, e il pulsante "Richiedi un sopralluogo" senza scroll
  2. La strip numerica mostra almeno tre trust signal (45 anni, 30 dipendenti, N cantieri) renderizzati lato server senza animazioni
  ...
  5. L'area di servizio (Mestre, Venezia, provincia, Veneto) è dichiarata esplicitamente nella pagina
**Plans**: TBD
**UI hint**: yes
