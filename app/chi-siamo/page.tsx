...
// Stub Phase 2 — La pagina reale arriva in Phase 5.
export default function ChiSiamoPage() {
  return (
    <section className="mx-auto max-w-2xl px-6 py-24">
      <p className="text-ink/60 text-sm font-medium tracking-widest uppercase">In arrivo</p>
      <h1 className="text-h1 text-ink font-serif leading-[1.1]">L&apos;Azienda</h1>
      <p className="text-ink/80 mt-6 max-w-prose text-lg">
        La pagina dell&apos;azienda è in lavorazione.
      </p>
    </section>
  );
}
